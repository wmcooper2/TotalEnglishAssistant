...
class Lists():
    """Container-class for commonly used categories. Returns None."""
    ...
    def initialize_prepositions(self):
        """Filters the prepositions into a list. Returns None."""
        for word in self.dictionary.dictionary.keys():
    ...
    def initialize_interjections(self):
        """Filters the interjections into a list. Returns None."""
        for word in self.dictionary.dictionary.keys():
