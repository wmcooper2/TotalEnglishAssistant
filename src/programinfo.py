...
class About():
    ...
    def __init__(self):
        ...
        self.program_info_message   = [self.program_version_info, 
                                       self.program_created_by]
    ...
    def show_dictionary_info(self):
        ...
        current_dictionary = ttk.Label(dictionary_box, 
                                       text=self.dictionary_name)
        current_dictionary.grid(column=0, row=0, padx=6, pady=6)
        
        total_words = ttk.Label(dictionary_box, 
            text="Total words: "+str(self.dictionary.size))
        ...
        grade_one_word_total = ttk.Label(unique_words, 
            text="Grade 1: "+self.grade_one_words)
        grade_one_word_total.grid(column=0, row=0, padx=6, pady=6, 
            sticky=tk.W)

        grade_one_word_total = ttk.Label(unique_words, 
            text="Grade 2: "+self.grade_two_words)
        grade_one_word_total.grid(column=0, row=1, padx=6, pady=6, 
            sticky=tk.W)

        grade_one_word_total = ttk.Label(unique_words, 
            text="Grade 3: "+self.grade_three_words)
        grade_one_word_total.grid(column=0, row=2, padx=6, pady=6, 
            sticky=tk.W)
    ...
    def show_license_info(self):
        ...
        for line in self.license_:
            ttk.Label(frame, text=line).grid(column=0, row=counter, 
                sticky=tk.W)
            counter = counter + 1
